...
from m3utils import load_dataset, data_split, muticlass_f1
import time
import random
import argparse
import numpy as np
...
SEEDS=[1941488137,2519445423,983997847,1254279832,4019585660,2108550661,1648766618,329014539,3212139042,2424918363]
training_time=[]
test_f1score=[]

features, label, dim = load_dataset(args.dataset, args.K, args.tau, args.tau1, args.tau2, args.plain)
