...
def load_dataset(dataset_name="cora", K=6, tau = 1.0, tau1 = 1.0, tau2 = 1.0, plain=False):    
    ...
    LP2, Propagate_matrix_time, sparse_mx_time=edgeindex_construct(edge_index, num_nodes, tau2)    
    t1 = time.time()            
    features=[feat]
    basis=feat  
    basis1=feat 
